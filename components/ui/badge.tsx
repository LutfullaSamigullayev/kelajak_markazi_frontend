  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        purple: "border-transparent bg-[#F0E6FA] text-[#5C2D91] font-bold dark:bg-[#2E0854] dark:text-[#BB94E8]",
        accent: "border-transparent bg-[#BB94E8] text-[#2E0854] font-extrabold",
      },
    },
    defaultVariants: {
      variant: "default",
